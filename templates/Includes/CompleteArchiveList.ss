<div class="row">
	<div class="col-md-12">
		<form method="post" action="$CurrentProject.Link/deletesnapshot">
			<h3>Snapshots</h3>
			<input type="submit" value="Bulk Delete" class="btn-warning bulk-delete-submit" disabled="true">
			<% if $CanViewArchives %>
									...
									<tr>
										...
										<td class="text-center">
											<div class="btn-group" role="group">
												...
												<% end_if %>
												<% if $CanDelete && $ArchiveFile %>
													<input type="checkbox" value="$ID" name="DataArchiveID[$ID]" class="bulk-delete-select">
												<% end_if %>
											</div>
										</td>
									</tr>
